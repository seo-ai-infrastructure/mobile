...
public final class ProbeActivity extends Activity {
    ...
    @Override public void onCreate(Bundle saved) {
        ...
        body.addView(text("DUOPLUS / SIMULATED DATA",12,ACCENT));
        TextView title=text("Scenario player",31,Color.WHITE); title.setPadding(0,dp(10),0,dp(10)); body.addView(title);
        ...
        String[][] names={{"gnss","GNSS · NMEA · satellite fixtures"},{"imu","IMU · synthetic motion"},{"magnetic","Magnetic field · modeled"},
        ...
        button(body,"Open separate hook diagnostics",()->startActivity(new Intent(this,HookDiagnosticsActivity.class)));
