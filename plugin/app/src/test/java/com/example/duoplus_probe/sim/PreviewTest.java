...
public final class PreviewTest {
    @Test public void renderPreviewDoesNotDispatchOrAlterPlaybackClock() throws Exception {
        ...
        assertSame(scenario,preview.scenario);assertEquals(0,preview.scenarioMs,0);
        ...
        assertEquals("Map cannot invent an update between pose deadlines",0,engine.preview(1_099_000_000L).scenarioMs,0);
        engine.tick(1_200_000_000L);
        ...
        assertEquals(200,engine.preview(10_100_000_000L).scenarioMs,0);
    ...
    @Test public void previewIgnoresConsumerTimestampAfterResume() throws Exception {
        ...
        assertEquals(0,engine.preview(Long.MAX_VALUE).scenarioMs,0);
